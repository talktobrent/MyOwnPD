function striper() {    // A reference to Stripe.js initialized with a fake API key.
    // Sign in to see examples pre-filled with your key.
    var stripe = Stripe("pk_test_yrUciPb9MbEyGmnnIJiZbhcc00CdGXux8H");
    ...
    var loading = function(isLoading) {
      if (isLoading) {
        ...
        document.querySelector("#strip button").disabled = true;
